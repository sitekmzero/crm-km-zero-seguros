DO $$
BEGIN
  -- 1. Add is_draft column to messages
  ...
  INSERT INTO public.configs (key, value) VALUES
    ('sdr_system_prompt', 'Você é um SDR virtual da KM Zero Seguros, Consórcios e Financiamentos. Seja conciso e educado.'),
    ('learning_mode_active', 'false')
  ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value WHERE public.configs.value IS NULL;
